...
class enum_declaration_list_node : public Node
{
  ...
  public:
  enum_declaration_list_node(const Node* Current_Enum_Declaration1, const Node* Next_Enum_Declaration) : CurrentEnumDeclaration(Current_Enum_Declaration1), NextEnumDeclaration(Next_Enum_Declaration)
  {
  ...
  {
    return NextEnumDeclaration != nullptr;
  }
  ...
  virtual std::ostream& print(std::ostream& outputstream, std::string IndentationLevel) const override //overloading operator to print contents of object.
  {
   ...
   {
      outputstream << std::endl;
      NextEnumDeclaration->print(outputstream, IndentationLevel + "  ");
    }
